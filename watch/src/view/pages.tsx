...
const Content = ({
  ...
  const filterInput = (
    <div class="relative rounded-xs shadow-xs flex-1">
      ...
      <input
        class="block w-full h-full rounded-md p-0 border-gray-300 dark:bg-slate-800 dark:text-slate-200 dark:border-gray-600 pl-7 focus:border-indigo-500 focus:ring-indigo-500"
        value={filter}
