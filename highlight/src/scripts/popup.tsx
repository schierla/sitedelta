...
const Content = ({
  ...
  return (
    <body class="py-2 min-w-[360px] dark:bg-slate-900 dark:text-slate-200">
      ...
      {expanded && config && (
        <div class="flex flex-col mx-4">
          <h2 class="font-semibold mt-2">{t("configChecks")}</h2>
          <ConfigCheckbox
            config={config}
          ...
          <h2 class="font-semibold mt-2">{t("configIgnores")}</h2>
          <ConfigCheckbox
            config={config}
          ...
          <h2 class="font-semibold mt-2">{t("configAppearance")}</h2>
          <ConfigCheckbox
            config={config}
          ...
          <h2 class="font-semibold mt-2">{t("configRegionsInclude")}</h2>
          <ConfigRegionList
            config={config}
            configKey="includes"
            ...
            UpdateConfig={UpdateConfig}
          />
          <h2 class="font-semibold mt-2">{t("configRegionsExclude")}</h2>
          <ConfigRegionList
            config={config}
            configKey="excludes"
