...
export const Button = (
  ...
  <button
    disabled={disabled}
    class={
      "border text-sm font-normal rounded-md shadow-2xs disabled:text-slate-500 disabled:bg-slate-50 disabled:hover:bg-slate-50 " +
      (large ? "px-4 py-2 " : "px-2 py-1 ") +
      (isDefault
        ? "border-transparent bg-indigo-600 text-white shadow-2xs hover:bg-indigo-700"
